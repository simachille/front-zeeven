  ...
  const onSubmit = (credentials: UserCredentials) => {
	...
	return (
        ...
        <div className="mb-3">
          ...
          <div className="mt-1">
            <input {...register("username")} type="text" className="text-black	form-control w-full border border-white rounded-lg shadow-sm" id="username"  />
          </div>
        ...
        <div className="mb-3">
          ...
          <div className="mt-1">
            <input {...register("password")} type="password" className="text-black	form-control w-full border border-white rounded-lg shadow-sm" id="password" />
          </div>
